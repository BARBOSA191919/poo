//leer 5 numeros por teclado, almacernarlos en un arrgeglos y a continuacion realizar 
...
public class ejercicio3 {
    ...
    public static void main(String[] args) {
        ...
        if (conteo_negativos == 0) {
            ...
            System.out.println("La media de los numeros negatvios es: " + media_negativos);
